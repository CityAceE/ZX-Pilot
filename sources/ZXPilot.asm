...
crc_scr         dc.l    0
scroll_y        dcb.w   40,0    ;Сдвиг от верха при масштабе 1:1
                dcb.w   40,128
                dcb.w   40,288
scroll_y_full   dcb.w   53,0    ;Сдвиг от верха при масштабе 1:1
                dcb.w   54,64
                dcb.w   53,128
scroll_y_const  dc.w    0
scroll_x        dcb.w   53,0    ;Сдвиг слева при масштабе 1:1
                dcb.w   54,6
                dcb.w   53,12
scroll_x_he     dcb.w   53,0    ;Сдвиг слева при масштабе 1:1
                dcb.w   54,1
                dcb.w   53,2
...
no_graffity
                ...
                move.b  keys(a5),d7
                cmp.b   #$01,d7
                beq     save_dialog             ;выход по клавише Power
...
poisk           addq.l  #1,a1
                ...
                adda.l  #$1800,a1
                move.l  a1,zx_atr(a5)   ;это адрес для хранения атрибутов
