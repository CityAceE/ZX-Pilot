...
;‘лаговый регистр
; Bit  ќбозначение    омментарии
;        Z80  M68K

;  0      C    C     ‘лаг переноса
;  1     P/V   V     ‘лаг четности/переполнени€
;  2      Z    Z     ‘лаг нул€
;  3      S    N     ‘лаг знака
;  4      3          *Ќедокументированный флаг
;  5      5          *Ќедокументированный флаг
;  6      N          *‘лаг сложени€/вычитани€
;  7      H          *‘лаг полупереноса
...
_3B     ;DEC SP
                ...
                bra     interrupt
_3C     ;INC A *
                move.b  d1,DAA(a5)     ;ƒл€ эмул€ции DAA
                addq.b  #1,d1
                move.w  sr,d7
                and.b   #%00001110,d7
                and.b   #%10110001,d0
...
_A0     ;AND B
                ...
                and.b   #%00001110,d7
                and.b   #%10110000,d0
                lea     parity(a5),a0   ;8    ”становка флага четности
                moveq.l #0,d6           ;4    дл€ ускорени€ эмул€ции
...
;                or.b    #%110000,d0        ;ƒл€ Ghost'N'Goblins
...
_CB     ;PREFIX
                ...
                move.w  (a2,d6.w),d7
                jmp     (a3,d7.w)
_CC     ;CALL Z,NN ;¬ќзможно здесь накос€чил
                move.l  a1,d6
                move.b  (a1)+,d7
                move.b  (a1)+,d6
                move.w  d0,ccr
...
;                data
;SndCommandPtr           dc.b    1,0     ; оманда sndCmdFreqDurationAmp и ноль
;                        dc.l    10000       ;„астота Hz
;                        dc.w    1    ;ƒлительность ms
;                        dc.w    64      ;√ромкость
;                code
...
;                bcs     _CB06wp
                ...
                or.b    d7,d0
                lea     parity(a5),a0   ;8    ”становка флага четности
                moveq.l #0,d7           ;4    дл€ ускорени€ эмул€ции
...
_ED42   ;SBC HL,BC
                ...
                and.b   #%10110000,d0
                or.b    d7,d0
                and.l   #$ff00ff,d2     ;строка дл€ корректной работы игры Movie
                and.l   #$ff00ff,d4     ;дл€ определени€ флага Z
                move.w  sr,d7           ;дл€ определени€ флага Z
                and.b   #%00000100,d7   ;дл€ определени€ флага Z
                or.b    d7,d0           ;дл€ определени€ флага Z
                add.w   #15,d5
                bcc     kernel
                bra     interrupt
_ED43   ;LD (NN),BC     ;@
...
_ED66   ;IM 0
                ...
                bcc     kernel
                bra     interrupt
_ED67   ;RRD    «десь впервые более оптимальный перегон рег. пары
                move.l  a1,d7
                swap    d4
                move.b  d4,-(a7)
                move.w  (a7)+,d7
